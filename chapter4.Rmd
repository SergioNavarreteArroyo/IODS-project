...
```
Presently, the main factor influencing Group 1 seems to be its proximity to the riverside. Group 3, on the other hand, appears to be primarily influenced by accessibility to radial highways. The remaining variables exhibit a collective clustering, with no individual variables prominently standing out.
